<template>
   <div class="container" :class="{ 'sign-up-mode': showRegister, 'sign-in-mode': showLogin }">
     <div class="form-warp">
       <!-- 根据showRegister的状态显示注册表单 -->
       <Register v-if="showRegister" />
       <!-- 根据showLogin的状态显示登录表单 -->
     ...
     <div class="desc-warp">
       ...
       <div class="desc-warp-item sign-up-desc">
         <div class="content">
           <button @click="toggleMode('sign-up-mode')">注册</button>
         </div>
         <img src="@/assets/RLImg/log.svg" alt="" />
       </div>
       <!-- 登录描述 -->
       <div class="desc-warp-item sign-in-desc">
         <div class="content">
           <button @click="toggleMode('sign-in-mode')">登录</button>
         </div>
         <img src="@/assets/RLImg/register.svg" alt="" />
       </div>
     </div>
   </div>
</template>
...
export default {
  ...
  methods: {
    toggleMode (mode) {
      this.showRegister = mode === 'sign-up-mode'
      this.showLogin = !this.showRegister
    },
    goToLayout () {
      this.$router.push('/layout/home') // 直接跳转到首页
    }
  }
}
</script>
